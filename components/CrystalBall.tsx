...
const CrystalBall: React.FC<CrystalBallProps> = ({ isLoading, onClick }) => {
  ...
  return (
    ...
    >
      ...
      {/* WRAPPER: Float Animation handles vertical movement. 
          It wraps the ball and its glows so they move together. 
          It persists during loading to prevent the "jump" effect. */}
      <div className="relative w-full h-full animate-float">
        ...
        <div className={`
          ...
          /* Scale handles the loading growth/hover effect, independent of floating */
          ${isLoading ? 'scale-105' : 'group-hover:scale-[1.02]'}
